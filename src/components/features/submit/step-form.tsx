      ...
      <div className="bg-surface border-border rounded-2xl border p-6 shadow-sm md:p-10">
        ...
        <form onSubmit={onSubmit} className="space-y-8">
          ...
          <div className="space-y-3">
            ...
            <Textarea id="story" placeholder="আপনার স্মৃতি বা গল্পটি বিস্তারিতভাবে লিখুন..." required className="min-h-37.5 resize-y text-base" />
          </div>
          {type === "game" && (
            <div className="space-y-3">
              <Label htmlFor="howToPlay" className="text-base">কীভাবে খেলতে হয়?</Label>
              <Textarea id="howToPlay" placeholder="খেলার নিয়ম, কতজন লাগে, কী কী জিনিস লাগে..." className="min-h-[120px] resize-y text-base" />
            </div>
          )}
          ...
          <div className="space-y-4">
            ...
            <RadioGroup defaultValue="self" className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="bg-background border-border flex items-center space-x-3 rounded-lg border p-4">
                ...
                <Label htmlFor="self" className="cursor-pointer font-normal">এটা আমার নিজের স্মৃতি</Label>
              </div>
              <div className="bg-background border-border flex items-center space-x-3 rounded-lg border p-4">
                <RadioGroupItem value="parents" id="parents" />
                <Label htmlFor="parents" className="cursor-pointer font-normal">বাবা-মায়ের কাছ থেকে শুনেছি</Label>
              </div>
              <div className="bg-background border-border flex items-center space-x-3 rounded-lg border p-4">
                <RadioGroupItem value="grandparents" id="grandparents" />
                <Label htmlFor="grandparents" className="cursor-pointer font-normal">দাদা/নানার কাছ থেকে শুনেছি</Label>
              </div>
              <div className="bg-background border-border flex items-center space-x-3 rounded-lg border p-4">
                <RadioGroupItem value="others" id="others" />
                <Label htmlFor="others" className="cursor-pointer font-normal">অন্য কারও কাছ থেকে শুনেছি</Label>
              </div>
            </RadioGroup>
          </div>
          <div className="space-y-3">
          ...
          <div className="border-border space-y-6 border-t pt-6">
            ...
            <div className="bg-muted border-border flex h-[65px] w-full max-w-[300px] items-center justify-center rounded-sm border p-2">
              <div className="flex w-full items-center gap-3">
                ...
                <span className="text-secondary-foreground text-sm font-medium">Verify you are human</span>
              </div>
            </div>
          </div>
          <Button type="submit" size="lg" className="bg-primary hover:bg-primary-hover text-primary-foreground h-14 w-full text-lg">
            সংরক্ষণ করুন
          </Button>
        </form>
      </div>
