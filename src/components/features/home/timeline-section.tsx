...
export function TimelineSection() {
  return (
    <PageSection className="bg-surface border-border border-y">
      <SectionHeader 
      ...
      <div className="flex justify-center">
        <div className="bg-background border-border/50 inline-flex max-w-full space-x-1 overflow-x-auto rounded-md border p-1 shadow-sm">
