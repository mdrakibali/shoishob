    ...
    <div className="bg-background min-h-screen py-16">
      <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          <h1 className="text-foreground mb-6 font-serif text-4xl font-bold md:text-5xl lg:text-6xl">
            কেন <span className="text-primary">Shoishob</span>?
          </h1>
          <p className="text-muted-foreground font-serif text-xl italic md:text-2xl">
            "আমাদের অনেক শৈশবের গল্প কোথাও লেখা নেই।"
          </p>
        </div>

        <div className="prose prose-lg md:prose-xl dark:prose-invert prose-headings:font-serif text-secondary-foreground mx-auto mb-16 max-w-none leading-relaxed">
        ...
        <div className="mb-16 grid grid-cols-1 gap-8 md:grid-cols-2">
          <div className="bg-surface border-border rounded-2xl border p-8">
            ...
            <h3 className="text-foreground mb-3 font-serif text-2xl font-bold">কীভাবে কাজ করে?</h3>
          ...
          <div className="bg-surface border-border rounded-2xl border p-8">
            ...
            <h3 className="text-foreground mb-3 font-serif text-2xl font-bold">মডারেশন</h3>
            <p className="text-secondary-foreground">
          ...
          <div className="bg-surface border-border rounded-2xl border p-8">
            ...
            <h3 className="text-foreground mb-3 font-serif text-2xl font-bold">তথ্যের উৎস</h3>
            <p className="text-secondary-foreground">
          ...
          <div className="bg-surface border-border rounded-2xl border p-8">
            ...
            <h3 className="text-foreground mb-3 font-serif text-2xl font-bold">ভবিষ্যতের স্বপ্ন</h3>
            <p className="text-secondary-foreground">
